...
from algorithms import normalize_dictionary, mp, omp,ols, ridge_regression
...
""" Le code ci-dessous est une copie du code  de la class TestOmp
...
class TestOls(unittest.TestCase):
    def test_with_identity_dictionary(self):
        ...
        # Estimate solution
        w_est, error_norm = ols(X=X, y=y, n_iter=n_iter)
